...
ActiveRecord::Schema.define(version: 20160707183551) do
  ...
  add_index "cities", ["cluster_id"], name: "index_cities_on_cluster_id"
  ...
  create_table "growth_profiles", force: :cascade do |t|
    ...
    t.integer  "converted_junior_youth_groups"
    t.integer  "converted_study_circles"
    t.text     "youth_conferences_accompaniments"
    t.text     "gregorian_cycle"
  end
